...
Um usuario voluntário faz cadastro, colcoa suas informações de localização, seu nivel de libras e assim, permite o surdo ja cadastrado a ter ajuda atraves do aplicativo. 
...
* Uso de Api de SMS: usuário que aceita um  pedido recebe um sms confirmando o aceite.
